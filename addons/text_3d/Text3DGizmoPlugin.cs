...
[Tool]
public partial class Text3DGizmoPlugin : EditorNode3DGizmoPlugin
{
	...
	{
		return forNode3D is Text3D;
	}

	internal Text3DGizmoPlugin()
	{
	...
	public override void _Redraw(EditorNode3DGizmo gizmo)
	{
		...
		if (node3d is not Text3D text3D) return;
